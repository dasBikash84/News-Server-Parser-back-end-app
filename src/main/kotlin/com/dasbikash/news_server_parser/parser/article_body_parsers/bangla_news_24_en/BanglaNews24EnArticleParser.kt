...
package com.dasbikash.news_server_parser.parser.article_body_parsers.bangla_news_24_en

import com.dasbikash.news_server_parser.parser.article_body_parsers.ArticleBodyParser
import org.jsoup.select.Elements

class BanglaNews24EnArticleParser : ArticleBodyParser() {
    ...
    override fun getFeaturedImageSelector(): String {
        return BanglaNews24EnArticleParserInfo.FEATURED_IMAGE_SELECTOR
    }

    override fun getFeaturedImageLinkSelectorAttr(): String {
        return BanglaNews24EnArticleParserInfo.FEATURED_IMAGE_LINK_SELECTOR_ATTR
    }

    override fun getFeaturedImageCaptionSelector(): String {
        return BanglaNews24EnArticleParserInfo.FEATURED_IMAGE_CAPTION_SELECTOR
    }
    ...
    override fun getArticleFragmentBlocks(): Elements {
        return mDocument.select(
                BanglaNews24EnArticleParserInfo.ARTICLE_FRAGMENT_BLOCK_SELECTOR
        )
    }

    override fun getParagraphImageSelector(): String {
        return BanglaNews24EnArticleParserInfo.PARAGRAPH_IMAGE_SELECTOR
    }

    override fun getParagraphImageLinkSelectorAttr(): String {
        return BanglaNews24EnArticleParserInfo.PARAGRAPH_IMAGE_LINK_SELECTOR_ATTR
    }
    ...
    override fun getParagraphImageCaptionSelectorAttr(): String {
        return BanglaNews24EnArticleParserInfo.PARAGRAPH_IMAGE_CAPTION_SELECTOR_ATTR
    }
}
