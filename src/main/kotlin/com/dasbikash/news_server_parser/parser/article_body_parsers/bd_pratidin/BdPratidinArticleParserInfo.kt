...
internal object BdPratidinArticleParserInfo {
    ...
    @JvmField val FEATURED_IMAGE_SELECTOR = ".main-image img"
    @JvmField val FEATURED_IMAGE_LINK_SELECTOR = "src"
    @JvmField val FEATURED_IMAGE_CAPTION_SELECTOR = ".text-center"

    @JvmField val ARTICLE_FRAGMENT_BLOCK_SELECTOR = "article p,article div:not(div[id],div[class])"
    ...
    @JvmField val ARTICLE_MODIFICATION_DATE_STRING_SELECTOR = ".post-time .row .row"//"#news_update_time"
